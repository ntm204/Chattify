      ...
      <div className="w-full">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full">
          ...
          <div className="mb-[10px]">
            ...
            />
            <div className="flex gap-1 mt-[-6px] px-1">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
          ...
          <div className="flex items-start gap-2 mt-2 mb-4 px-1">
            <input
              {...register("agree")}
              type="checkbox"
              id="agree-terms"
              className="mt-1 w-[15px] h-[15px] accent-[var(--foreground)] cursor-pointer"
            />
            <label htmlFor="agree-terms" className="text-[13px] text-[var(--text-secondary)] leading-tight cursor-pointer select-none">
              I agree to the <Link href="#" className="text-[var(--link-color)] hover:opacity-75">Terms of Use</Link> and <Link href="#" className="text-[var(--link-color)] hover:opacity-75">Privacy Policy</Link>
            </label>
          </div>
          {errors.agree && <p className="mt-[-12px] mb-4 ml-1 text-xs text-red-500/80 font-medium">{errors.agree.message}</p>}
